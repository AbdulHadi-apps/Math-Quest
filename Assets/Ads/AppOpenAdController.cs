...
public class AppOpenAdController : MonoBehaviour
{
...
#if UNITY_ANDROID
    private const string _adUnitId = "ca-app-pub-2181080351880117/7141659938";
#elif UNITY_IPHONE
    ...
    public void LoadAd()
    {
       ...
       // AdController.Instance.Logger("Loading app open ad.");
        ...
        AppOpenAd.Load(_adUnitId, adRequest, (AppOpenAd ad, LoadAdError error) =>
        {
            ...
            if (error != null)
            {
               // AdController.Instance.Logger("App open ad failed to load an ad with error : " + error);
                return;
            }
            ...
            if (ad == null)
            {
               // AdController.Instance.Logger("Unexpected error: App open ad load event fired with " +   " null ad and null error.");
                return;
            }

            // The operation completed successfully.
           // AdController.Instance.Logger("App open ad loaded with response : " + ad.GetResponseInfo());
            _appOpenAd = ad;
